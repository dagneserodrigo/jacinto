	...
	*******************
	...
	<div class="wpc-hosting-plans wpc-pricing classic">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-5 col-sm-offset-2 no-padding-sm">
					<div class="wrapper first">
						<div class="title">
						Plano Básico
						</div>
						<div class="price"><sup>R$</sup>3.99</div>
						<div class="period">por mês</div>
						<a href="get-started.php?plan=basic" class="wpc-btn">Contratar</a>
					</div>
				</div>
				<div class="col-sm-5 no-padding-sm">
					<div class="wrapper act">
						...
						<div class="price"><sup>R$</sup>5.99</div>
						<div class="period">por mês</div>
						<a href="get-started.php?plan=premium" class="wpc-btn">Contratar</a>
					</div>
				</div> 
			</div>
			<div class="row">
				<div class="col-sm-12 no-padding-sm">
					<div class="table-responsive">
						<table class="table">
							...
							<tr>
								<td class="title-table" colspan="">Panel Control Panel</td>
								<td><img src="img/check-2.png" alt="check"></td>
								<td><img src="img/check-2.png" alt="check"></td>
							</tr>
							<tr>
